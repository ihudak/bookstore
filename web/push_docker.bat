...
docker image build --platform=linux/arm64 -t ghcr.io/ihudak/web-agents-arm64:latest --build-arg AGENT=agents .

docker image build --platform=linux/amd64 -t ghcr.io/ihudak/web-preinstrument-x64:latest --build-arg AGENT=preinstrument .
docker image build --platform=linux/arm64 -t ghcr.io/ihudak/web-preinstrument-arm64:latest --build-arg AGENT=preinstrument .
