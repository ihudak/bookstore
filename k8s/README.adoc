...
==== Linux
    ...
    ./delete.sh -all   # undeploys everything, including the DBs, configmap, secrets, and namespace
...
==== Linux
    ...
    .\delete.bat -all   &REM undeploys everything, including the DBs, configmap, secrets, and namespace
