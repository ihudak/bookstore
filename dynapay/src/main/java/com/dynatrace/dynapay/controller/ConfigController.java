...
public class ConfigController {
    ...
    public Config getConfigById(@Parameter(name="id", description = "setting identifier: dt.failure.payment.percent; dt.work.hard; dt.simulate.crash", example = "dt.failure.payment.percent") @PathVariable String id) {
    ...
    public Config updateConfig(@Parameter(name="id", description = "setting identifier: dt.failure.payment.percent; dt.work.hard; dt.simulate.crash", example = "dt.work.hard") @PathVariable String id, @RequestBody Config config) {
    ...
    public void deleteConfig(@Parameter(name="id", description = "setting identifier: dt.failure.payment.percent; dt.work.hard; dt.simulate.crash", example = "dt.simulate.crash") @PathVariable String id) {
