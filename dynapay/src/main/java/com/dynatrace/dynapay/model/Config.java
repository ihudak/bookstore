package com.dynatrace.dynapay.model;
...
public class Config implements ConfigModel {
    @Id
    @Schema(name = "id", example = "dt.failure.payment.percent", requiredMode = Schema.RequiredMode.REQUIRED, description = "dt.failure.payment.percent - how many payments to fail (in %);  dt.work.hard - simulates CPU/RAM load; dt.simulate.crash - simulates service crashes")
    private String id;
    ...
    @Schema(name = "probab_fail", example = "75", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "for dt.failure.payment.percent - how many % of payments to fail; for dt.simulate.crash - the probability to crash")
