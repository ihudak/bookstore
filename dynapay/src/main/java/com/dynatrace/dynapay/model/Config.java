...
public class Config implements ConfigModel {
    ...
    @Schema(name = "probab_fail", example = "75", requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "for dt.failure.payment.percent only - how many % of payments to fail")
